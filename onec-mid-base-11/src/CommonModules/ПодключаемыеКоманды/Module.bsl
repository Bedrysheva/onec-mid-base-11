...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	Если ИмяФормы =  "Документ.ЗаказПокупателя.Форма.ФормаДокумента" Тогда
		Р1_ДоработкаДокументов.ВывестиПолеКонтактноеЛицо(Форма);
		
		// ++ Бедрышева Н.В. Задача "Согласованная скидка" (09.02.2025)
		Р1_ДоработкаДокументов.ВывестиКнопкуИПолеСогласованнаяСкидка(Форма);
		// -- Бедрышева Н.В. Задача "Согласованная скидка" (09.02.2025)
	ИначеЕсли  ИмяФормы =  "Документ.ОплатаОтПокупателя.Форма.ФормаДокумента" ИЛИ 
			 ИмяФормы =  "Документ.ОплатаПоставщику.Форма.ФормаДокумента" ИЛИ 
	...
	КонецЕсли;
	// -- Бедрышева Н.В. Задача "Контактное лицо" (09.02.2025) 
